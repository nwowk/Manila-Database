...
if (isset($_POST['geography']) && isset($_POST['geovalue'])) {
	...
	$query = "SELECT district, zone, project_id, COUNT(1) as 'households', 
		...
		FROM households
		WHERE HHLDsize > 0 AND $geography='$geovalue'
		GROUP BY $geography";		
...
<p>*Percentages marked with this symbol represent percent of <? echo $geography; ?> <em>population</em>.</p>
<p>The other percentages represent percent of <? echo $geography; ?> <em>households</em>.</p>
